#!/usr/bin/env python3
"""
🚀 RAULI System Service Manager - Solución Profesional Definitiva
Gestor de servicios Windows con interfaz gráfica profesional
"""
...
class RAULIServiceManager:
    def __init__(self):
        ...
        # Inicializar servicios ANTES de setup_ui
        self.services = {
    ...
    def setup_ui(self):
        ...
        # Panel de control
        control_frame = ttk.LabelFrame(main_frame, text="🎛️ Control del Sistema", padding="10")
                    ...
                    if self.services["ollama"]["status"] == "running":
                        try:
                            ...
                            if response.getcode() != 200:
                                ...
                                self.log_message("Ollama dejó de responder", "WARNING")
                        except:
                            self.update_service_status("ollama", "stopped", None)
                            self.log_message("Ollama dejó de responder", "WARNING")
